...
var Eva = new Kid('Eva', 'Girl', 'Strawberry', 'Snow White', 'child1.jpg', [3, 4, 4, 4, 3, 3], 
...
var Zack = new Kid('Zack', 'Boy', 'Milk', 'Lightening Macqueen', 'child6.jpg', [2, 1, 4, 2, 3, 4], 
...
var Tony = new Kid('Tony', 'Boy', 'Cheese', 'King Lion', 'child13.jpg', [4, 4, 1, 1, 4, 3], 
...
var appendToResults = function(){
  ...
  firstH3.innerHTML = 'Top Match: ' + myKidScores[0].name;
  var secondH3 = document.getElementById('secondH3');
  secondH3.innerHTML = '2nd Match: ' + myKidScores[1].name;
  var thirdH3 = document.getElementById('thirdH3');
  thirdH3.innerHTML = '3rd Match: ' + myKidScores[2].name;
